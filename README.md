...
For guidance on when a contributor may merge without waiting for peer approval, and when approval is mandatory, refer to the [pull request approval policy](./pull-request-approval-policy.md).
